...
import { Shipping, ShippingValidator } from '@/pages/checkout'
...
export default function ShippingDetails({ shippingInfo, setShipping, shippingValidator }: Props) {
    ...
    <form className="flex w-full flex-col flex-wrap gap-3 p-5 grow bg-gray-50 rounded-lg mt-5 m-5 shadow">
      <label className="flex relative w-full flex-col">
        <div className="flex flex-row">
          ...
          {!shippingValidator.email && <span className="mb-3 ml-auto text-xs text-red-800"> Please input a valid email address </span>}
        </div>
      ...
      <div className="flex flex-row flex-wrap grow gap-3" >
        <label className="flex relative flex-1 flex-col md:w-full">
          <div className="flex flex-row">
            ...
            {!shippingValidator.email && <span className="mt-0.5 ml-2 text-xs text-red-800"> (required) </span>}
          </div>
